...
mod tests {
    ...
    use crate::{
        ...
        FungibleState, Genesis, GenesisSeal, GlobalState, GlobalStateType, GraphSeal, Identity,
        Inputs, MetaType, Metadata, OpId, Opout, RevealedData, RevealedValue, SchemaId,
